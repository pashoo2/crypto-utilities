...
var verifyNative = function (key, data, signature) { return __awaiter(void 0, void 0, void 0, function () {
    var res, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (key.type !== data_sign_utils_const_1.DATA_SIGN_CRYPTO_UTIL_VERIFY_KEY_TYPE) {
                    return [2 /*return*/, new Error("The type of the key " + key.type + " may not be used for data decryption")];
                }
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, init_1.cryptoModuleDataSign.verify(__assign({}, data_sign_utils_const_1.DATA_SIGN_CRYPTO_UTIL_DATA_SIGN_AND_VERIFY_PARAMS), key, signature, data)];
            case 2:
                res = _a.sent();
...
var verifyData = function (key, data, signature) { return __awaiter(void 0, void 0, void 0, function () {
    var k, d, s;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, keys_data_sign_utils_1.dataSignGetKeyOfType(key, data_sign_utils_const_1.DATA_SIGN_CRYPTO_UTIL_VERIFY_KEY_TYPE)];
            case 1:
                k = _a.sent();
                ...
                s = typeof signature === 'string' ? typed_array_utils_1.convertToTypedArray(signature) : signature;
                if (s instanceof Error) {
                    return [2 /*return*/, s];
                }
                return [2 /*return*/, exports.verifyNative(k, d, s)];
        }
    });
}); };
